(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccountService = /** @class */ (function () {
                function AccountService(ngRedux) {
                ...
                AccountService.prototype.xolo = function () {
                    console.log(this.user);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccountComponent = /** @class */ (function () {
                function AccountComponent(ngRedux, dbService, routeHelper) {
                    this.ngRedux = ngRedux;
                ...
                AccountComponent.prototype.ngOnInit = function () {
                    ...
                    this.user$.subscribe(function (user) { return _this.userAccountInput.birthday = user.birthday; });
                ...
                AccountComponent.prototype.attemptAccountUpdate = function () {
                ...
                AccountComponent.prototype.submitPasswordConfirm = function () {
                    console.log(this.confirmationInput);
                    this.attemptAccountUpdate();
                };
                AccountComponent.prototype.attemptPasswordChange = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ADD_CAT = 'ADD_CAT';
            var addCat = function (payload) { return ({
                type: ADD_CAT,
                payload: payload
            }); };
            var LOG_IN_SUCCESS = "LOG_IN_SUCCESS";
            var loginSuccess = function (payload) { return ({
                type: LOG_IN_SUCCESS,
                payload: payload
            }); };
            var LOG_OUT = "LOG_OUT";
            ...
            var refreshState = function (payload) { return ({
                type: REFRESH_STATE,
                payload: payload
            }); };
            //thunk actions
            ...
            var logIn = function (userCredentials) { return function (dispatch) {
                console.log('dispatching LOG_IN');
                var username = userCredentials.username, password = userCredentials.password;
            ...
            var signUp = function (newUser) { return function (dispatch) {
                console.log('dispatching signUp');
                var username = newUser.username, password = newUser.password, passwordConfirm = newUser.passwordConfirm, firstName = newUser.firstName, lastName = newUser.lastName, birthday = newUser.birthday;
                return axios__WEBPACK_IMPORTED_MODULE_1___default()({
            ...
            var refreshStateWithToken = function (token) { return function (dispatch) {
                return axios__WEBPACK_IMPORTED_MODULE_1___default()({
            ...
            var setAuthToken = function (payload) { return ({
                type: SET_AUTH_TOKEN,
                payload: payload
            }); };
            var storeAuthInfo = function (data) { return function (dispatch) {
            ...
            var jwtDecode = function (authToken) {
            ...
            var saveAuthToken = function (authToken) {
                localStorage.setItem('authToken', authToken);
            };
            var refreshAuthToken = function (token, data) { return function (dispatch) {
                return axios__WEBPACK_IMPORTED_MODULE_1___default()({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var AppToastService = /** @class */ (function () {
                function AppToastService() {
                    this.toasts = [];
                }
                AppToastService.prototype.show = function (header, body, options) {
                    if (options === void 0) { options = {}; }
                    this.toasts.push(Object.assign({ header: header, body: body }, options));
                };
                AppToastService.prototype.remove = function (toast) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppToastsComponent = /** @class */ (function () {
                function AppToastsComponent(toastService) {
                    this.toastService = toastService;
                }
                AppToastsComponent.prototype.ngOnInit = function () {
                };
                return AppToastsComponent;
            }());
            AppToastsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(ngRedux, dbService, toastService) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
                    this.toastService = toastService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CatCardComponent = /** @class */ (function () {
                function CatCardComponent(ngRedux, dbService, toastService) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
                    this.toastService = toastService;
                    this.showToast = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CatResultsComponent = /** @class */ (function () {
                function CatResultsComponent() {
                }
                CatResultsComponent.prototype.ngOnInit = function () {
                };
                return CatResultsComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DatabaseService = /** @class */ (function () {
                function DatabaseService(http, ngRedux) {
                    this.http = http;
                    this.ngRedux = ngRedux;
                    this.httpOptions = {
                ...
                DatabaseService.prototype.ngOnInit = function () {
                    var _this = this;
                    this.user$.subscribe(function (user) { return _this.username = user.username; });
                    this.user$.subscribe(function (user) { return _this.user = user; });
                    console.log(this.user);
                };
                DatabaseService.prototype.refreshStateViaToken = function () {
                ...
                DatabaseService.prototype.obtainAndRefreshTokenAndState = function () {
                    var _this = this;
                    var authToken = localStorage.getItem('authToken');
                    if (authToken) {
                        //if we have an authToken, that means we have already signed in. So we want to
                ...
                DatabaseService.prototype.addCatToDB = function (cat) {
                    var _this = this;
                    this.user$.subscribe(function (user) { return _this.username = user.username; });
                ...
                DatabaseService.prototype.removeCatFromDB = function (catID) {
                    ...
                    return axios__WEBPACK_IMPORTED_MODULE_4___default()({
                        ...
                        .then(function (response) {
                        console.log(response);
                        _this.refreshStateViaToken();
                    })
                        .catch(function (err) { return console.error(err); });
                };
                DatabaseService.prototype.attemptPasswordUpdate = function (username, object) {
                    var password = object.password, newPW = object.newPW;
                ...
                DatabaseService.prototype.attemptAccountUpdateDB = function (username, userInfo, confirmInfo) {
                    console.log('attemptAccountUpdateDB running');
                    var firstName = userInfo.firstName, lastName = userInfo.lastName, birthday = userInfo.birthday, zodiacCombo = userInfo.zodiacCombo;
                    var password = confirmInfo.password, confirm = confirmInfo.confirm;
                    ...
                    return axios__WEBPACK_IMPORTED_MODULE_4___default()({
                        ...
                        data: {
                            firstName: firstName, lastName: lastName, birthday: birthday, password: password, confirm: confirm, username: username, zodiacCombo: zodiacCombo
                        }
                    })
                        .then(function (response) {
                        console.log(response);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(ngRedux, routeHelper, toastService) {
                    this.ngRedux = ngRedux;
                    this.routeHelper = routeHelper;
                    this.toastService = toastService;
                ...
                HeaderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.user$.subscribe(function (user) { return _this.loggedInStatus = user.loggedIn; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KennelCardComponent = /** @class */ (function () {
                function KennelCardComponent(dbService, toastService) {
                    this.dbService = dbService;
                    this.toastService = toastService;
            ...
            KennelCardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _database_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../database.service */ "./src/app/database.service.ts");
            /* harmony import */ var _route_helper_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../route-helper.service */ "./src/app/route-helper.service.ts");
            var KennelComponent = /** @class */ (function () {
                function KennelComponent(ngRedux, dbService, routeHelper) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
                    this.routeHelper = routeHelper;
                }
                KennelComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.routeHelper.bouncer();
                    // this.dbService.obtainAndRefreshTokenAndState();
                    this.user$.subscribe(function (user) { return _this.kennelCats = user.cats; });
                };
                return KennelComponent;
            }());
            KennelComponent.ctorParameters = function () { return [
                { type: _angular_redux_store__WEBPACK_IMPORTED_MODULE_2__["NgRedux"] },
                { type: _database_service__WEBPACK_IMPORTED_MODULE_3__["DatabaseService"] },
                { type: _route_helper_service__WEBPACK_IMPORTED_MODULE_4__["RouteHelperService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(ngRedux, router, toastService) {
                    this.ngRedux = ngRedux;
                    this.router = router;
                    this.toastService = toastService;
                ...
                LoginComponent.prototype.toastSuccessAndRedirect = function () {
                    var _this = this;
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.ngRedux.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_3__["logIn"])(this.userCredentials)).then(function () {
                        localStorage.getItem('authToken') ? _this.toastSuccessAndRedirect() : _this.toastService.show("Grab Dat Cat", "Login Failed", { classname: 'bg-danger text-light', delay: 5000 });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PetFinderService = /** @class */ (function () {
                ...
                PetFinderService.prototype.errorHandler = function (error) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["throwError"])(error.message || 'Server Error');
                };
                PetFinderService.prototype.getCatBreeds = function () {
                    ...
                    return axios__WEBPACK_IMPORTED_MODULE_2___default()({
                        ...
                        .then(function (response) {
                        return response.data.breeds.map(function (catBreed) {
                            return catBreed.name;
                        });
                    })
                        .catch(function (err) { return console.error(err); });
                };
                PetFinderService.prototype.getCatColorCoatSex = function () {
                ...
                // //       });
                //   } 
                PetFinderService.prototype.seekCats = function (cattributes) {
                    var breed = cattributes.breed, coat = cattributes.coat, color = cattributes.color, gender = cattributes.gender, age = cattributes.age;
                    var body = { breed: breed, coat: coat, color: color, gender: gender, age: age };
            ...
            PetFinderService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var RouteHelperService = /** @class */ (function () {
                function RouteHelperService(router) {
                    this.router = router;
                }
            ...
            RouteHelperService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponent = /** @class */ (function () {
                function SearchComponent(petFinderService, ngRedux, accountService, routeHelper) {
                ...
                SearchComponent.prototype.ngOnInit = function () {
                    ...
                    this.catCoats = this.petFinderService.getCatColorCoatSex().then(function (res) { return res.coats; });
                    this.catColors = this.petFinderService.getCatColorCoatSex().then(function (res) { return res.colors; });
                    this.catGenders = this.petFinderService.getCatColorCoatSex().then(function (res) { return res.genders; });
                    this.user$.subscribe(function (user) { return _this.user = user; });
                ...
                SearchComponent.prototype.onSubmit = function () {
                    ...
                    this.petFinderService.seekCats(this.queryForm.value).subscribe(function (data) {
                        console.log(data);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(ngRedux) {
                    this.ngRedux = ngRedux;
                    this.model = {};
