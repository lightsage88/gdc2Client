(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AccountComponent = /** @class */ (function () {
                function AccountComponent(ngRedux, dbService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(ngRedux, dbService) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CatCardComponent = /** @class */ (function () {
                function CatCardComponent(ngRedux, dbService) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DatabaseService = /** @class */ (function () {
                ...
                DatabaseService.prototype.attemptAccountUpdateDB = function (username, userInfo, confirmInfo) {
                    var firstName = userInfo.firstName, lastName = userInfo.lastName, birthday = userInfo.birthday;
                    ...
                    return axios__WEBPACK_IMPORTED_MODULE_4___default()({
                        ...
                        data: {
                            firstName: firstName, lastName: lastName, birthday: birthday, password: password, confirm: confirm, username: username
                        }
                    })
                        .then(function (response) {
                        console.log(response);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KennelCardComponent = /** @class */ (function () {
                function KennelCardComponent(dbService) {
                    this.dbService = dbService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KennelComponent = /** @class */ (function () {
                function KennelComponent(ngRedux, dbService) {
                    this.ngRedux = ngRedux;
                    this.dbService = dbService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(ngRedux) {
                    this.ngRedux = ngRedux;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponent = /** @class */ (function () {
                function SearchComponent(petFinderService, ngRedux) {
            ...
            function rootReducer(state, action) {
                switch (action.type) {
                    ...
                    case _actions__WEBPACK_IMPORTED_MODULE_1__["LOG_IN_SUCCESS"]:
                        ...
                        var _a = action.payload.user, username = _a.username, firstName = _a.firstName, lastName = _a.lastName, birthday = _a.birthday, cats = _a.cats;
